...
comm_choice = [{1:"Advance to Go!",2:"Bank error in your favour! Collect $200",3:"Dentist fee- Pay $100",4:"You sold your stocks,Collect $50",5:"Go To Jail for tax evasion",6:"Holiday fund: Collect $100",7:"Its your Birthday!Collect $15 from every player!",8:"Pay hospital fees $100",9:"Recieve a $25 consultancy fees",10:"You inherit $100"},
               {1:"Go back 3 spaces",2:"Speeding fine £15",3:"Parking fine $15",4:"Your Xmas fund matures. Collect $100",5:'You have won a crossword competition. Collect £100',6:'Pay school tax of $150',7:"You have been elected Chairman of the Board. Pay each player £50",8:"Advance to Trafalgar Square. If you pass Go, collect £200",9:"Advance to Mayfair",10:"Advance to Pall Mall. If you pass Go, collect £200"}]
...
while True:
    ...
    if property_data[player_data[i]['pos']]['type'] == 'community chest':
        if random.randint(0,1) == 1:
            player_data[i]['credit'] += 200
            print(f'Player{player_data[i]["sprite"]} has been credited $200 since his luck is good')
        else:
            print(f"$200 has been debited from Player {player_data[i]['sprite']} due to unforseen circumstances")
            player_data[i]['credit'] -= 200
